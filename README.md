...
> [!NOTE]
> The MySocial Messaging Stack tooling is currently in Beta.
>
...
>
> For questions, feedback, or production discussions, reach out to the team on [Telegram](https://t.me/myso_community).
...
- [Installation](docs/myso-messaging-stack/Installation.md)
- [Setup](docs/myso-messaging-stack/Setup.md)
- [Examples](docs/myso-messaging-stack/Examples.md)
- [API Reference](docs/myso-messaging-stack/APIRef.md)
- [Encryption](docs/myso-messaging-stack/Encryption.md)
- [Security](docs/myso-messaging-stack/Security.md)
- [Relayer](docs/myso-messaging-stack/Relayer.md)
- [Attachments](docs/myso-messaging-stack/Attachments.md)
- [Archive & Recovery](docs/myso-messaging-stack/ArchiveRecovery.md)
- [Group Discovery](docs/myso-messaging-stack/GroupDiscovery.md)
- [Extending](docs/myso-messaging-stack/Extending.md)
- [Testing](docs/myso-messaging-stack/Testing.md)

---

Messaging tooling for Web3 applications, built on [MySocial](https://mysocial.network), [MyData](https://github.com/the-social-proof-foundation/myso-mydata), and [File Storage](https://mysocial.network/storage).
...
- [**@socialproof/myso**](https://docs.mysocial.network/mysocial/developers/typescript): MySo TypeScript SDK
