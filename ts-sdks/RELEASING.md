# Releasing `@socialproof/myso-messaging-stack`
...
Every PR that changes the public `@socialproof/myso-messaging-stack` package should include a **changeset** — a small markdown file that describes the change and its semver impact (patch / minor / major).
...
```bash
cd ts-sdks/packages/myso-messaging-stack
pnpm build
npm login
...
- Repository: `socialproof/myso-messaging-stack`
