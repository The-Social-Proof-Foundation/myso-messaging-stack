...
1. [development phase] Publish a Move package to a chosen MySo network
...
- For the use cases (1) and (2), install MySo CLI.
- For the use case (3), install Docker.

## Use Case (1): [development phase] Publish a move package to a MySo Network

1. Create a `.env` file following the structure of the [.env.example](./.env.example).
2. Fill in the variables:

- `MYSO_FULLNODE_URL`: RPC URL for the target network.
