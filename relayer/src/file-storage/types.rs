//! File Storage API response types and error definitions.
...
pub enum FileStorageError {
    ...
    #[error("File Storage API error: {status} - {message}")]
...
pub struct BlobStoreResponse {
    ...
    /// Present if this exact blob content already exists on File Storage
    #[serde(skip_serializing_if = "Option::is_none")]
