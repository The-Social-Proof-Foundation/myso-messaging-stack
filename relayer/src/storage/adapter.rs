...
pub trait StorageAdapter: Send + Sync {
    ...
    /// Used by the File Storage background sync job to track message backup state.
    /// Returns the updated message.
    ...
    /// Used by the File Storage sync job to find messages pending backup.
    ///
    /// # Example
    /// ```ignore
    /// // Find messages waiting to be synced to File Storage
